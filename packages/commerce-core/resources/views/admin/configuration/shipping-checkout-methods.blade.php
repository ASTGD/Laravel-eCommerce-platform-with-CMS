<div class="grid gap-4">
    <div class="rounded-lg border border-blue-100 bg-blue-50 p-4 text-sm text-blue-900 dark:border-blue-900 dark:bg-blue-950 dark:text-blue-100">
        Keep all customer-facing delivery choices in one place. These options control what buyers see at checkout, while courier service setup still lives under <strong>Sales &gt; Courier Services</strong>.
    </div>
