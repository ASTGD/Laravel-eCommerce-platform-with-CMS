...
@pushOnce('scripts')
    ...
    >
        <div>
            ...
            >
                <div
                    class="absolute z-10 w-max rounded border border-slate-200 bg-white text-gray-700 shadow-[0px_8px_10px_0px_rgba(0,0,0,0.20),0px_6px_30px_0px_rgba(0,0,0,0.12),0px_16px_24px_0px_rgba(0,0,0,0.14)] dark:border-gray-800 dark:bg-gray-900 dark:text-gray-300"
