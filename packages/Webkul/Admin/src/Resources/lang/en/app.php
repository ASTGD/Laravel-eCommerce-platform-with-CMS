...
return [
    ...
    'sales' => [
        'orders' => [
            ...
            'view' => [
                ...
                'confirm' => 'Confirm',
                'confirm-error' => 'Only pending orders can be confirmed.',
                'confirm-msg' => 'Are you sure you want to confirm this order?',
        ...
        'rma' => [
            'all-rma' => [
                ...
                'view' => [
                    ...
                    'close-rma' => 'Product return is closed',
                    ...
                    'confirm-print' => 'Click OK to print product return',
                    'conversation-process' => 'Your product return request has been processed.',
                    ...
                    'on' => 'On',
                    'order-date' => 'Order Date :',
                    'order-details' => 'Item Requested for Product Return',
                    'order-id' => 'Order ID :',
                    'order-status' => 'Delivery Status :',
                    ...
                    'status' => 'Status',
                    'status-message' => 'Your product return ID #:id status has been changed. Status: :status',
                    'status-reopen' => 'Reopen Request',
                    'title' => 'Product Return',
                    'update-success' => 'Product return status updated successfully.',
                    'reopen-not-allowed' => 'Reopening this product return request is not allowed.',
                    'view-title' => 'Product Return',
                ],
            ],

            'rma-status' => [
                'index' => [
                    'create-btn' => 'Create Product Return Status',
                    ...
                    'datagrid' => [
                        ...
                        'created-at' => 'Created At',
                        'delete' => 'Delete',
                        'delete-success' => 'Product return status deleted successfully.',
                        'disabled' => 'Inactive',
                        'edit' => 'Edit',
                        'enabled' => 'Active',
                        'id' => 'ID',
                        'mass-delete-success' => 'Selected product return status deleted successfully.',
                        'reason-error' => 'Product return status is used in Product Return.',
                        'reason' => 'Product Return Status',
                        'status' => 'Status',
                        'title' => 'Title',
                        'update' => 'Update',
                    ],
                ...
                'create' => [
                    'create-title' => 'Add New Product Return Status',
                    'reason' => 'Product Return Status',
                    'save-btn' => 'Save Product Return Status',
                    'status' => 'Status',
                    'success' => 'Product return status created successfully.',
                ],

                'edit' => [
                    'edit-title' => 'Edit Product Return Status',
                    'mass-update-success' => 'Selected product return status updated successfully.',
                    'reason' => 'Product Return Status',
                    'save-btn' => 'Save Product Return Status',
                    'status' => 'Status',
                    'success' => 'Product return status updated successfully.',
                ],
            ],

            'reasons' => [
                'index' => [
                    'create-btn' => 'Create Product Return Reason',
                    'title' => 'Reasons',
                    ...
                    'datagrid' => [
                        ...
                        'reason-error' => 'Reason is used in Product Return.',
                        'reason' => 'Reason',
                        'status' => 'Status',
                        'update' => 'Update',
                    ],
            ...
            'custom-field' => [
                'index' => [
                    ...
                    'title' => 'Product Return Custom Fields',
            ...
            'rules' => [
                'index' => [
                    'create-btn' => 'Create Product Return Rules',
                    'title' => 'Product Return Rules',

                    'datagrid' => [
                        'delete' => 'Delete',
                        'delete-success' => 'Product return rules deleted successfully.',
                        'disabled' => 'Inactive',
                        'edit' => 'Edit',
                        'enabled' => 'Active',
                ...
                'create' => [
                    'create-title' => 'Add New Product Return Rules',
                    'reason' => 'Product Return Rules',
                    'resolutions-period' => 'Resolutions Period',
                    'rule-description' => 'Rules Description',
                    'rule-details' => 'Rules Details',
                    'rules-title' => 'Rules Title',
                    'save-btn' => 'Save Product Return Rules',
                    'status' => 'Product Return Status',
                    'success' => 'Product return rules created successfully.',
                ],

                'edit' => [
                    'edit-title' => 'Edit Product Return Rules',
                    'mass-update-success' => 'Selected product return rules updated successfully.',
                    'reason' => 'Product Return Rules',
                    'save-btn' => 'Update Product Return Rules',
                    'status' => 'Status',
                    'success' => 'Product return rules updated successfully.',
                ],
            ],

            'create-rma' => [
                'conversation-process' => 'Your product return request has been processed.',
                'create-success' => 'Product return created successfully.',
                'create-title' => 'Create Product Return',
                'email' => 'Email',
                'failed' => 'Failed to create product return.',
                'image' => 'Image',
                'invalid-order-id' => 'Invalid order Id',
                'mismatch' => 'Order Id and email mismatch',
                'new-rma' => 'New Product Return',
                'order-id' => 'Order Id',
                'quantity' => 'Quantity',
                'reason' => 'Reason',
                'rma-already-exist' => 'Product return already exists',
                'rma-not-available-quotes' => 'Item not available for product return',
                'save-btn' => 'Save',
                'search' => '--Select--',
                'validate' => 'Validate',
            ],
            ...
            'invoice' => [
                'create' => [
                    ...
                    'rma-created-message' => 'A product return request is available for the product with a quantity of :qty',
                    'rma-has-been-created' => 'Product return has been created',
                ],
            ],
        ...
        'index' => [
            ...
            'sales' => [
                ...
                'rma' => [
                    ...
                    'allow-new-request-for-pending-order' => 'Allow new product return request for pending order',
                    'allow-product-type-for-rma' => 'Allow Product Type For Product Return',
                    'allow-rma-for-digital-product' => 'Allow Product Return for digital product',
                    ...
                    'allowed-request-cancelled-request' => 'Allow New Product Return Request For Cancelled Request',
                    'allowed-request-declined-request' => 'Allow New Product Return Request For Declined Request',
                    'allowed-rma-for-product' => 'Allowed Product Return For Product',
                    'cancel-items' => 'Cancel-items',
                    'complete' => 'Complete',
                    'current-order-quantity' => 'Current Order Quantity',
                    'days-info' => 'The number of days within which the customer can request a product return after placing an order.',
                    'default-allow-days' => 'Default allowed days',
                    'enable' => 'Enable Product Return',
                    'evening' => 'Evening',
                    'exchange' => 'Exchange',
                    'info' => 'Product Return is part of the process of returning a product to a business to receive a refund, replacement, or repair.',
                    'morning' => 'Morning',
                    'new-rma-message-to-customer' => 'New Product Return Message to Customer',
                    'no' => 'No',
                    'open' => 'Open',
                    'package-condition' => 'Package Condition',
                    'packed' => 'Packed',
                    'print-page' => 'Print Product Return',
                    'product-already-raw' => 'Product is already in Product Return.',
    ...
    'errors' => [
        ...
        '429' => [
            'description' => 'Too many login attempts were made in a short time. For security, this access is temporarily blocked. Please wait a minute and try again.',
    ...
    'emails' => [
        ...
        'rma' => [
            'conversation' => [
                'heading' => 'Hello :name',
                'message' => 'Message',
                'quotes' => 'You have received a new message in your product return conversation.',
                'subject' => 'New Product Return Conversation Message',
                'title' => 'New Product Return Conversation',
            ],
        ],
    ],
];
