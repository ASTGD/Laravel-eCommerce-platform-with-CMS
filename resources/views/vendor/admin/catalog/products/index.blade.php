        ...
        <template #body="{
            ...
            <template v-else>
                ...
                >
                        ...
                        <div class="flex items-start justify-between gap-3">
                            <div class="flex items-start gap-2.5">
                                ...
                                <div class="flex flex-col gap-1 flex-1">
                                    <button
                                        type="button"
                                        class="flex items-center gap-1 text-left text-sm font-semibold text-gray-800 transition-all hover:text-blue-600 dark:text-white dark:hover:text-blue-400 sm:text-base"
                                        v-if="record.has_variants"
                                        @click="record.is_expanded = !record.is_expanded"
                                    >
                                        ...
                                        <i
                                            class="text-base"
                                            :class="record.is_expanded ? 'icon-sort-up' : 'icon-sort-down'"
                                        ></i>
                                    </button>

                                    <p
                                        class="break-all text-sm font-semibold text-gray-800 dark:text-white sm:text-base"
                                        v-else
                                    >
                                        @{{ record.name }}
                                    </p>
                    ...
                    <div class="hidden md:contents">
                        ...
                        <div class="flex gap-2.5">
                            ...
                            <div class="flex flex-col gap-1.5">
                                <button
                                    type="button"
                                    class="flex items-center gap-1 text-left text-base font-semibold text-gray-800 transition-all hover:text-blue-600 dark:text-white dark:hover:text-blue-400"
                                    v-if="record.has_variants"
                                    @click="record.is_expanded = !record.is_expanded"
                                >
                                    <span class="break-all">
                    ...
                    <div
                        class="mt-4 rounded-xl border border-slate-200 bg-slate-50 p-3 dark:border-gray-800 dark:bg-gray-900/70 md:col-span-3"
                        v-if="record.has_variants && record.is_expanded"
                    >
                        <div class="mb-3 flex items-center justify-between gap-2">
                            ...
                            <p class="text-xs text-gray-500 dark:text-gray-300">
                                @{{ record.variant_count }} variants under this product
                            </p>
                        </div>

                        <div class="grid gap-2.5">
                            <div
                                class="flex flex-col gap-3 rounded-lg border border-slate-200 bg-white px-3 py-3 dark:border-gray-800 dark:bg-gray-950 md:flex-row md:items-center md:justify-between"
                                v-for="variant in record.variants"
                            >
                                <div class="flex items-start gap-3">
                                    <div
                                        class="relative h-12 w-12 overflow-hidden rounded border border-slate-200 bg-white dark:border-gray-800 dark:bg-gray-900"
                                    ...
                                    <div
                                        class="relative h-12 w-12 rounded border border-dashed border-gray-300 dark:border-gray-800 dark:mix-blend-exclusion dark:invert"
                                        v-else
                                    >
                                        <img
                                    ...
                                    <div class="grid gap-1">
                                        <a
                                            class="text-sm font-semibold text-gray-800 transition-all hover:text-blue-600 hover:underline dark:text-white dark:hover:text-blue-400"
                                ...
                                <div class="flex flex-wrap items-center gap-x-4 gap-y-1 text-xs text-gray-600 dark:text-gray-300 md:justify-end">
                                    ...
                                    <span :class="[variant.status ? 'label-active' : 'label-info']">
