...
<v-checkout-address-customer
    :cart="cart"
    :customer-draft='@json($customerCheckoutDraft)'
                    ...
                    <form @submit="handleSubmit($event, addAddressToCart)">
                        ...
                        <div class="mb-2 grid grid-cols-2 gap-5 max-1060:grid-cols-[1fr] max-lg:grid-cols-2 max-md:mt-2 max-md:grid-cols-1">
                            ...
                            <div
                                ...
                                @click="selectedAddressForEdit = null; activeAddressForm = 'billing'"
        ...
        app.component('v-checkout-address-customer', {
            ...
            methods: {
                ...
                getActiveAddress() {
                    ...
                    if (! this.activeAddressForm) {
                        return undefined;
                    }

                    const cartAddress = this.cart[this.activeAddressForm + '_address'];

                    if (cartAddress) {
                        return cartAddress;
                    }

                    if (! this.customerDraft) {
                        return undefined;
                    }

                    return {
                        ...structuredClone(this.customerDraft),
                        address: [...(this.customerDraft.address || [''])],
                    };
                },
