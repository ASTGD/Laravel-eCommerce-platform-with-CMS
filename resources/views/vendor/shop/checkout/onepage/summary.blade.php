...
<div class="mb-8 mt-6 grid gap-4 max-md:mb-0 max-sm:mt-4 max-sm:gap-2.5">
    ...
    <div
        class="rounded-lg bg-gray-50 p-3 text-sm text-zinc-600"
        v-if="cart.shipping_method === 'courier_pickup'
            && cart.shipping_address
            && cart.shipping_address.additional
            && cart.shipping_address.additional.pickup_point"
    >
        ...
        <p>
            @{{ cart.shipping_address.additional.pickup_point.name }}
        </p>

        <p v-if="cart.shipping_address.additional.pickup_point.courier_name">
            @{{ cart.shipping_address.additional.pickup_point.courier_name }}
        </p>

        <p>
            @{{ cart.shipping_address.additional.pickup_point.address_line_1 }}
        </p>

        <p>
            @{{ cart.shipping_address.additional.pickup_point.city }}
            <template v-if="cart.shipping_address.additional.pickup_point.state">, @{{ cart.shipping_address.additional.pickup_point.state }}</template>
        </p>
    </div>
